...
/*
   ...
   This is much more reliable on Android/mobile browsers.
*/
...
async function masterGoogleLogin() {
  ...
  try {
    ...
    if (
      ...
      alert(
        "Firebase Auth SDK is not loaded."
      );
...
async function checkGoogleRedirectLogin() {
  ...
  try {
    ...
    /*
       Only Master Admin Gmail allowed.
    */
    ...
    if (
      ...
      alert(
        "❌ Firebase Authorized Domain പ്രശ്നം.\n\n" +
        "Firebase Console → Authentication → Settings → Authorized domains\n" +
        "എന്നതിൽ നിങ്ങളുടെ website domain ചേർക്കണം."
      );
    ...
    if (
      ...
      alert(
        "❌ ഈ browser environment-ൽ Google Login support ചെയ്യുന്നില്ല."
      );
...
window.checkGoogleRedirectLogin =
...
window.addEventListener(
  ...
  async () => {
    ...
    */
    ...
    /*
       2. IMPORTANT:
       Check Google redirect BEFORE anything else
       that may hide the master panel.
    */

    try {

      await checkGoogleRedirectLogin();

    } catch (e) {

      console.error(
        "Google redirect check failed:",
        e
      );
    }
